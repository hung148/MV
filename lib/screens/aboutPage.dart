        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 16),
              const Text(
                'Building precision parts and lasting partnerships since 1999',
                style: TextStyle(
                  fontSize: 20,
                  ...
                  return Wrap(
                    ...
                    children: [
                      _buildValueCard(
                        icon: Icons.stars,
                        title: 'Quality First',
                        description: 'We never compromise on quality. Every part is inspected to ensure it meets or exceeds specifications.',
                        width: isWide ? 350 : double.infinity,
                      ),
                      _buildValueCard(
                        icon: Icons.handshake,
                        title: 'Integrity',
                        description: 'Honest communication, fair pricing, and transparent processes build trust with our clients.',
                        width: isWide ? 350 : double.infinity,
                      ),
                      _buildValueCard(
                        icon: Icons.lightbulb,
                        title: 'Innovation',
                        description: 'Continuous investment in technology and training keeps us at the forefront of the industry.',
                        width: isWide ? 350 : double.infinity,
                      ),
                      _buildValueCard(
                        icon: Icons.people,
                        title: 'Teamwork',
                        description: 'Our skilled team works collaboratively to solve challenges and deliver exceptional results.',
                        width: isWide ? 350 : double.infinity,
                      ),
                      _buildValueCard(
                        icon: Icons.psychology,
                        title: 'Customer Focus',
                        description: 'Understanding and exceeding customer expectations drives everything we do.',
                        width: isWide ? 350 : double.infinity,
                      ),
                      _buildValueCard(
                        icon: Icons.trending_up,
                        title: 'Continuous Improvement',
                        description: 'We constantly refine our processes and capabilities to better serve our customers.',
                        width: isWide ? 350 : double.infinity,
                      ),
                    ],
                  );
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Icon(icon, size: 40, color: const Color(0xFF0d47a1)),
          ),
                  ...
                  return Wrap(
                    ...
                    children: [
                      _buildTeamMember(
                        ...
                        title: 'Founder & CEO',
                        description: 'Master machinist with 35+ years of experience. Leads strategic vision and client relationships.',
                        width: isWide ? 350 : double.infinity,
                      ),
                      _buildTeamMember(
                        name: 'Sarah Chen',
                        title: 'VP of Operations',
                        description: 'Aerospace engineer overseeing production, quality control, and continuous improvement initiatives.',
                        width: isWide ? 350 : double.infinity,
                      ),
                      _buildTeamMember(
                        name: 'Robert Martinez',
                        title: 'Director of Engineering',
                        description: 'CAD/CAM expert managing programming team and technical customer support.',
                        width: isWide ? 350 : double.infinity,
                      ),
                    ],
                  );
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 16),
              const Text(
                'Experience the MV Machine Shop difference',
                style: TextStyle(
                  fontSize: 18,
                  color: Colors.white70,
                ),
